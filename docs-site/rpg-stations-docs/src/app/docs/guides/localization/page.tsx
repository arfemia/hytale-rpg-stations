...
export const metadata: Metadata = {
  title: 'Localization',
  description: 'The lang families RPG Stations content resolves display text through.',
  openGraph: {
    title: 'Localization | RPG Stations Docs',
    description: 'rpgstations.lang and the native item/emote namespaces.',
  },
}
...
export default function LocalizationPage() {
  return (
    <DocPage
      title="Localization"
      description="Two lang families cover every piece of display text RPG Stations content can author"
    ...
    >
      <p>
        ...
        namespace the content belongs to: RPG Stations&apos; own generic UI/content strings, or a native
        Hytale asset&apos;s own name/description.
      </p>
...
RPG_Station_Sawmill.hint.loaded = Press [{key}] to work`}</code></pre>
      ...
      <H2 id="why-two-families">Why two families, not one</H2>
      <p>
        Each family belongs to the system that owns the content it describes: RPG Stations owns its own
        generic UI vocabulary and per-station convention keys; the native engine owns every item/emote
        asset&apos;s text regardless of which mod placed that asset. Keeping them separate means a pack never
        has to guess which file a given piece of text belongs in - the OWNER of the asset the text describes
      ...
      <p>
        ...
        <code>rpgstations.lang</code>, and not documented here.
      </p>
    </DocPage>
  )
}
